        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-8">
              <h3 className="text-2xl font-bold text-text-primary mb-6">{t('aboutPage.mission.values.title')}</h3>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary mb-2">{t('aboutPage.mission.values.quality.title')}</h4>
                    <p className="text-text-secondary">{t('aboutPage.mission.values.quality.description')}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary mb-2">{t('aboutPage.mission.values.community.title')}</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary mb-2">{t('aboutPage.mission.values.trust.title')}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-text-secondary">{t('aboutPage.impact.freelancers')}</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-text-secondary">{t('aboutPage.impact.clients')}</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-text-secondary">{t('aboutPage.impact.projects')}</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-text-secondary">{t('aboutPage.impact.earned')}</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-2">{t('aboutPage.team.members.anousone.name')}</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-2">{t('aboutPage.team.members.thipphasone.name')}</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-2">{t('aboutPage.team.members.thidaphone.name')}</h3>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-8">
              <h3 className="text-2xl font-bold text-text-primary mb-6">{t('aboutPage.story.beliefs.title')}</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                  <p className="text-text-secondary">{t('aboutPage.story.beliefs.belief1')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                  <p className="text-text-secondary">{t('aboutPage.story.beliefs.belief2')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-success rounded-full mt-2"></div>
                  <p className="text-text-secondary">{t('aboutPage.story.beliefs.belief3')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-warning rounded-full mt-2"></div>
                  <p className="text-text-secondary">{t('aboutPage.story.beliefs.belief4')}</p>
                </div>
              </div>
            </div>
          </div>
