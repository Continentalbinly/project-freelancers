const en = {
    ...
    cookieConsent: {
        ...
        bannerDesc: 'We use cookies to make our website work properly, analyze usage, and enhance your experience. By using this site, you accept our use of cookies.',
        acceptAll: 'Accept all',
        rejectAll: 'Reject all',
        preferences: 'Cookie preferences',
        essentialCookies: 'Essential cookies',
        essentialCookiesDesc: 'Necessary for the website to function properly',
        essentialCookiesDetail: 'These cookies are required for the website to work and cannot be disabled.',
        performanceCookies: 'Performance cookies',
        performanceCookiesDesc: 'Help us understand how visitors interact with our site',
        performanceCookiesDetail: 'These cookies help us analyze site usage to improve our services.',
        functionalityCookies: 'Functionality cookies',
        functionalityCookiesDesc: 'Remember your settings and preferences',
        functionalityCookiesDetail: 'These cookies allow the site to remember your choices for a better experience.',
        targetingCookies: 'Targeting cookies',
        targetingCookiesDesc: 'Used to deliver relevant advertising',
        targetingCookiesDetail: 'These cookies may be set by our advertising partners to build a profile of your interests.',
        savePreferences: 'Save preferences',
        policyLink: 'You can change your cookie settings at any time in our cookie policy'
    },
    // Header translations
    header: {
        home: 'Home',
    ...
    // Footer translations
    footer: {
        companyDescription: 'The largest academic freelancing community where students can earn income while studying.',
        platform: 'Platform',
    ...
    contact: {
        ...
        faqTeacherAnswer: 'Create an account, go to "Post Project", fill in the details, and wait for student proposals.',
        faqPaymentTitle: 'How are payments handled?',
        faqPaymentAnswer: 'We use secure payment processing. Funds are held until the project is completed and approved.',
        faqDisputeTitle: 'What if I am not satisfied with the work?',
        faqDisputeAnswer: 'We have a dispute resolution process. Contact our support team for assistance.',
    ...
    aboutPage: {
        ...
        mission: {
            ...
            values: {
                ...
                quality: {
                    title: 'Quality',
                    description: 'We maintain high standards for both students and teachers to ensure effective results.'
                },
                community: {
                    title: 'Community',
                    description: 'Create a supportive network where students and teachers can grow together.'
                },
                trust: {
                    title: 'Trust',
                    description: 'Secure payments and transparent processes build trust between all parties.'
                }
            }
        },
        impact: {
        ...
        team: {
            ...
            members: {
                anousone: {
                    ...
                    role: 'Founder & CEO',
                    description: 'Visionary leader passionate about connecting freelancers and clients. Driving innovation in the freelance market.'
                },
                thipphasone: {
                    name: 'Thipphasone Chanthabandith',
                    role: 'Co-founder & CTO',
                    description: 'Technology expert and co-founder focused on creating scalable, secure platforms that empower the future of freelance work.'
                },
                thidaphone: {
                    name: 'Thidaphone Houngyachith',
                    role: 'Co-founder & Head of Operations',
                    description: 'Operations expert and co-founder focused on creating smooth experiences and building strong relationships in the community.'
                }
            }
        },
        story: {
        ...
        cta: {
            ...
            subtitle: 'Be part of the movement that\'s revolutionizing how students and teachers work together.',
    ...
    careers: {
        ...
        mission: {
            ...
            whyWorkWithUs: {
                ...
                innovation: {
                    title: 'Innovation',
                    description: 'Work with cutting-edge technology that\'s transforming education and freelance work.'
                },
                impact: {
                    title: 'Impact',
                    description: 'Make a real difference in students\' lives and the future of education.'
                },
                flexibility: {
                    title: 'Flexibility',
        ...
        openPositions: {
            ...
            subtitle: 'Join our growing team and help build the future of professional freelance work',
            noPositions: {
                title: 'No Open Positions',
                subtitle: 'We\'re not hiring at the moment, but we\'re always looking for talented individuals',
                description: 'While we don\'t have any positions open right now, we\'re always interested in hearing from individuals who are passionate about making a difference in education and technology.',
                contactUs: 'Contact Us',
        ...
        benefits: {
            ...
            competitiveSalary: {
                ...
                description: 'Comprehensive compensation packages with equity options for full-time positions.'
            },
            remoteFirst: {
                title: 'Remote-First',
                description: 'Work from anywhere with flexible hours and remote-friendly culture.'
            },
            healthWellness: {
            ...
            teamEvents: {
                title: 'Team Events',
                description: 'Regular team building activities, remote events, and annual retreats.'
            },
            flexiblePto: {
                title: 'Flexible PTO',
                description: 'Generous paid time off with unlimited sick days and mental health days.'
            }
        },
        culture: {
            title: 'Our Culture',
            subtitle: 'We believe in creating an environment where everyone can thrive and make meaningful impact',
            innovation: {
                title: 'Innovation',
            ...
            collaboration: {
                title: 'Collaboration',
                description: 'We work together, share knowledge, and support each other\'s growth.'
            },
            impact: {
                title: 'Impact',
                description: 'We focus on making a real difference in students\' and teachers\' lives.'
            },
            diversity: {
                title: 'Diversity',
                description: 'We celebrate different perspectives and create an inclusive environment.'
            }
        },
        cta: {
            title: 'Ready to Join Our Team?',
            subtitle: 'Don\'t see a position that fits? We\'re always looking for talented individuals who are passionate about education and technology.',
            contactUs: 'Contact Us',
            sendResume: 'Send Resume'
        }
    },
        ...
        signup: {
            ...
            step1: {
                ...
                freelancer: {
                    ...
                    description: 'Find freelance opportunities and earn income while working'
                },
                client: {
            ...
            step2: {
                ...
                userCategory: {
                    ...
                    student: {
                        title: 'Student',
                        description: 'I am currently studying and want to earn income while learning'
                    },
                    worker: {
                        title: 'Professional Worker',
                        description: 'I am a working professional with experience in my field'
                    },
                    freelancer: {
                        title: 'Freelancer (Online/Independent)',
                        description: 'I work online or independently (not a student or company worker)'
                    }
                },
                studentInfo: {
                    ...
                    bio: 'Bio',
                    bioPlaceholder: 'Tell us about your background, interests, and goals...',
                ...
                pureFreelancerInfo: {
                    ...
                    bio: 'Bio',
                    bioPlaceholder: 'Tell us about your freelance experience and skills...',
                    hourlyRate: 'Hourly Rate (LAK)',
                    hourlyRatePlaceholder: '300000',
                    hourlyRateHint: 'Enter hourly rate in Lao Kip (₭)',
                    skills: 'Skills',
                ...
                workerInfo: {
                    ...
                    bioPlaceholder: 'Tell us about your professional experience and expertise...',
                    hourlyRate: 'Hourly Rate (LAK)',
                ...
                clientCategory: {
                    ...
                    teacher: {
                        title: 'Teacher',
                        description: 'I am a teacher or academic who wants to post projects and hire freelancers.'
                    },
                    worker: {
                        title: 'Professional Worker',
                        description: 'I am a working professional or business looking to hire freelancers.'
                    },
                    freelancer: {
                        title: 'Freelancer (Client)',
                        description: 'I am a freelancer who also wants to post projects and hire others.'
                    }
                }
            },
            step3: {
                ...
                termsOfService: {
                    label: 'I agree to the Terms of Service and understand that I am responsible for my account and activities on the platform. *',
                    link: 'Terms of Service'
                },
                privacyPolicy: {
                    label: 'I have read and accept the Privacy Policy and consent to the storage and use of my personal data. *',
                    link: 'Privacy Policy'
                },
                marketingEmails: {
                    label: 'I would like to receive marketing emails about new features, opportunities, and platform updates. (Optional)'
                }
            },
            navigation: {
                previous: 'Previous',
    ...
    help: {
        ...
        sections: {
            ...
            forFreelancers: {
                ...
                description: 'Complete guide for freelancers to find projects, submit proposals, and get paid.',
                link: 'Freelancer Guide →'
            },
            forClients: {
                title: 'For Clients',
                description: 'Learn how to post projects, review proposals, and manage your projects efficiently.',
                link: 'Client Guide →'
            },
            payments: {
                title: 'Payments & Billing',
                description: 'Understand how payments work, fees, and how to manage your billing information.',
                link: 'Payment Guide →'
            },
            safety: {
                title: 'Safety & Security',
                description: 'Learn about our safety measures and how to stay safe while using the platform.',
                link: 'Safety Guide →'
            },
            troubleshooting: {
                title: 'Troubleshooting',
                description: 'Common issues and solutions. Find quick answers to technical problems.',
                link: 'Troubleshoot →'
            }
        },
        videoTutorials: {
            ...
            tutorials: {
                gettingStarted: {
                    ...
                    description: 'Complete walkthrough of creating an account and setting up your profile.',
                    duration: 'Duration: 5 minutes'
                },
                postProject: {
                    title: 'How to Post a Project',
                    description: 'Learn how to create compelling project descriptions that attract the right freelancers.',
                    duration: 'Duration: 8 minutes'
                },
                submittingProposals: {
                    title: 'Submitting Proposals',
                    description: 'Tips for writing winning proposals that stand out to clients.',
        ...
        contactSupport: {
            ...
            subtitle: 'Can\'t find what you\'re looking for? Our support team is here to help you succeed.',
    ...
    faq: {
        ...
        noResults: 'No questions found for this category. Try selecting a different category.',
        contactSection: {
        ...
        questions: {
            ...
            projectTypes: {
                ...
                answer: 'Projects range from research assistance and data analysis to programming, design, translation, teaching, and administrative work. All projects focus on academic and professional development for students.'
            },
            // Freelancer Questions
            howToStartAsFreelancer: {
                question: 'How do I get started as a freelancer?',
                answer: 'Register for a free account, create your profile with skills and experience, browse available projects, and submit proposals to clients. Once hired, you can start working and earning income.'
            },
            whatSkillsNeeded: {
                question: 'What skills do I need to join?',
                answer: 'You must be a current university student with relevant skills for the projects you want to work on. Common skills include research, writing, programming, design, data analysis, and language abilities.'
            },
            howMuchCanIEarn: {
                question: 'How much can I earn as a freelancer?',
                answer: 'Earnings vary by project type, complexity, and your skills. Freelancers typically earn 250,000-1,500,000 Kip per hour or 500,000-1,000,000 Kip per project, depending on available work.'
            },
            howDoIGetPaid: {
                question: 'How do I get paid?',
                answer: 'Payments are handled securely through our platform. When projects are completed and approved by clients, funds are released to your account. You can withdraw to bank account or PayPal.'
            },
            whatIfICantComplete: {
                question: 'What if I can\'t complete a project?',
                answer: 'Communication is key. If you encounter issues, contact the client immediately. We have dispute resolution processes, and early communication often prevents problems.'
            },
            // Client Questions
            howToPostProject: {
                question: 'How do I post a project as a client?',
                answer: 'Create an account, go to \'Post Project\', add project details including requirements, budget, and timeline. Freelancers will submit proposals, and you can choose the best candidates.'
            },
            howToChooseFreelancer: {
                question: 'How do I choose the right freelancer?',
                answer: 'Review freelancer profiles, portfolios, ratings, and previous work. Look for freelancers with relevant skills and experience. You can also ask questions during the proposal process.'
            },
            whatIfNotSatisfied: {
                question: 'What if I\'m not satisfied with the work?',
                answer: 'Contact our support team immediately. We have dispute resolution processes, and we\'ll work with both parties to find a satisfactory solution.'
            },
            howMuchToBudget: {
                question: 'How much should I budget for a project?',
                answer: 'Budgets vary by project type and complexity. Research projects typically cost 100,000-800,000 Kip, programming projects 200,000-1,500,000 Kip, and design projects 75,000-500,000 Kip. Consider scope and timeline.'
            },
            canIHireSameFreelancer: {
                question: 'Can I hire the same freelancer again?',
                answer: 'Yes! If you\'re satisfied with a freelancer\'s work, you can hire them for future projects. Many clients build long-term relationships with trusted freelancers.'
            },
            // Payment Questions
            howDoPaymentsWork: {
                question: 'How do payments work?',
                answer: 'We use an escrow payment system. When you hire a freelancer, funds are held securely until the project is completed and you\'re satisfied. This protects both parties.'
            },
            whatPaymentMethods: {
                question: 'What payment methods do you accept?',
                answer: 'We accept major credit cards, PayPal, and bank transfers. All payments are handled securely through our platform.'
            },
            whenDoFreelancersGetPaid: {
                question: 'When do freelancers get paid?',
                answer: 'Freelancers get paid when projects are completed and approved by clients. This typically happens within 24-48 hours after project completion.'
            },
            areThereFees: {
                question: 'Are there any fees?',
                answer: 'We charge a small fee (typically 5-10%) on completed projects to maintain the platform, provide support, and ensure secure transactions.'
            },
            // Technical Questions
            technicalIssues: {
            ...
            howToUpdateProfile: {
                ...
                answer: 'Go to your dashboard, click on \'Profile\', and you can update your information, skills, portfolio, and settings anytime.'
            }
        }
    },
    ...
    pricing: {
        ...
        launchPhase: {
            ...
            subtitle: 'We\'re in our initial launch phase, which means all features are completely free for both freelancers and clients. Take advantage of this opportunity to build your portfolio and find great opportunities.',
            notice: {
                title: '🚀 First Launch Notice',
                message: 'The fee for making the website live is FREE until the next phase! This is part of our website roadmap plan.',
                details: 'During this launch phase, we\'re offering all premium features at no cost to help build our community and gather feedback.'
            },
            currentPlan: {
                price: 'Free',
                period: 'Launch Phase',
        ...
        futurePlans: {
            ...
            subtitle: 'As we grow and add more features, we\'ll introduce premium plans while keeping the core platform accessible to everyone.',
            basic: {
                title: 'Basic',
                price: 'Free',
                period: 'Forever',
        ...
        faq: {
            ...
            questions: {
                isItReallyFree: {
                    ...
                    answer: 'Yes! During our launch phase, all features are completely free for both freelancers and clients. This includes unlimited projects, proposals, and full platform access.'
                },
                whenWillPricingChange: {
                    question: 'When will the pricing change?',
                    answer: 'We\'ll provide plenty of notice before introducing any fees. The launch phase will continue until we\'ve built a strong community and gathered sufficient feedback.'
                },
                whatHappensToExistingUsers: {
                    question: 'What happens to existing users when pricing changes?',
                    answer: 'Existing users will be grandfathered into favorable terms, and we\'ll always maintain a free tier for basic platform access.'
                },
                areThereHiddenFees: {
                    question: 'Are there any hidden fees?',
                    answer: 'No hidden fees! During the launch phase, everything is completely free. When we introduce pricing, it will be transparent and clearly communicated.'
                },
                canICancelAnytime: {
                    question: 'Can I cancel my plan anytime?',
                    answer: 'Yes, you can cancel or downgrade your plan at any time. There are no long-term contracts or cancellation fees.'
                }
            }
        }
    },
    ...
    howItWorks: {
        hero: {
            title: 'How It Works',
            subtitle: 'A simple, secure platform for freelancers to earn money while gaining real-world experience in our community'
        },
        forFreelancers: {
            title: 'For Freelancers',
            subtitle: 'Find freelance work that aligns with your skills and career goals',
            steps: [
                {
                    title: 'Create Your Profile',
                    description: 'Sign up and create a detailed profile showcasing your skills, education, and experience. Add your portfolio and set your rates.'
                },
                {
                    title: 'Browse Projects',
                    description: 'Search through available projects from clients and businesses. Filter by skills, budget, and project type.'
                },
                {
                    title: 'Apply & Work',
                    description: 'Submit proposals, communicate with clients, complete projects, and earn money while building your portfolio.'
                }
            ]
        },
        forClients: {
            title: 'For Clients',
            subtitle: 'Find talented freelancers to help with your projects and business needs',
            steps: [
                {
                    title: 'Post Your Project',
                    description: 'Create detailed project descriptions with requirements, budget, and deadlines. Specify the skills you need.'
                },
                {
                    title: 'Review Proposals',
                    description: 'Review proposals from qualified freelancers. Check their profiles, portfolios, and previous work.'
                },
                {
                    title: 'Collaborate & Pay',
                    description: 'Hire the best freelancer, collaborate through our platform, and pay securely when the project is complete.'
                }
            ]
        },
        platformFeatures: {
            ...
            features: [
                {
                    ...
                    description: 'Escrow protection ensures both parties are satisfied before payment is released.'
                },
                {
                    title: 'Built-in Messaging',
                    description: 'Communicate directly with project partners through our secure messaging system.'
                },
                {
                    title: 'Progress Tracking',
                    description: 'Monitor project progress, set milestones, and track deliverables in real-time.'
                },
                {
                    title: 'Rating System',
                    description: 'Build reputation through reviews and ratings from completed projects.'
                },
                {
                    title: 'Flexible Scheduling',
                    description: 'Work around your schedule with flexible deadlines and remote collaboration.'
                },
                {
                    title: 'Professional Focus',
                    description: 'Projects designed specifically for professional freelancers and business clients.'
                }
            ]
        },
        cta: {
    ...
    freelancersPage: {
        hero: {
            title: 'For Freelancers',
            subtitle: 'Find freelance opportunities and earn money while building your skills',
            startEarning: 'Start Earning',
            browseProjects: 'Browse Projects'
        },
        howItWorks: {
            title: 'How It Works',
            subtitle: 'Start earning money with your skills in just a few simple steps',
            steps: [
                {
                    title: '1. Create Your Profile',
                    description: 'Sign up and build your professional profile. Showcase your skills, experience, and portfolio to attract clients.'
                },
                {
                    title: '2. Find Projects',
                    description: 'Browse available projects that match your skills. Apply with competitive proposals and showcase your expertise.'
                },
                {
                    title: '3. Earn Money',
                    description: 'Complete projects successfully and get paid securely. Build your reputation and earn more with each project.'
                }
            ]
        },
        benefits: {
            ...
            features: [
                {
                    ...
                    description: 'Set your own rates and work on projects that fit your schedule. Earn money while building your portfolio.'
                },
                {
                    title: 'Build Your Portfolio',
                    description: 'Complete real projects and build a professional portfolio that showcases your skills and experience.'
                },
                {
                    title: 'Learn & Grow',
                    description: 'Work on diverse projects to expand your skills and gain valuable real-world experience.'
                },
                {
                    title: 'Direct Communication',
                    description: 'Communicate directly with clients through our secure messaging system for clear project requirements.'
                },
                {
                    title: 'Secure Payments',
                    description: 'Get paid securely through our escrow system. Your earnings are protected and released upon project completion.'
                },
                {
                    title: 'Build Relationships',
                    description: 'Develop long-term relationships with clients and get repeat projects for steady income.'
                }
            ]
        },
        popularSkills: {
            title: 'Popular Skills in Demand',
            subtitle: 'These skills are highly sought after by clients on our platform',
            skills: [
                {
                    title: 'Programming',
        ...
        portfolio: {
            ...
            subtitle: 'Discover amazing work from our talented freelancers across various categories',
            viewMore: 'View More Projects',
            noProjects: 'No Completed Projects Yet',
            noProjectsDesc: 'Be the first to complete a project and showcase your work here!',
            items: [
                {
                    title: 'E-commerce Website Development',
                    description: 'Modern responsive e-commerce platform with payment integration and admin dashboard',
                ...
                },
                {
                    ...
                    description: 'React Native app for food delivery service with real-time tracking and payment',
                    freelancer: 'Alex Kumar',
                    budget: '₭3.2M'
                },
                {
                    title: 'SEO Content Strategy',
                    description: 'Comprehensive content strategy with 50+ articles and keyword optimization',
                ...
                },
                {
                    ...
                    description: 'Complete website translation in 5 languages with cultural adaptation',
                    freelancer: 'Nina Translator',
                    budget: '₭1.5M'
                },
                {
                    title: 'Market Research Report',
                    description: 'Comprehensive market analysis with competitor research and growth recommendations',
                ...
                },
                {
                    ...
                    description: 'Multi-platform social media campaign with 300% engagement increase',
        ...
        successStories: {
            ...
            stories: [
                ...
                },
                {
                    name: 'Mike Rodriguez',
                    role: 'Content Writer',
                    quote: 'Started as a part-time freelancer, now I\'m earning a steady income while studying. Great way to gain experience!',
                    earnings: '₭2M+ earned'
                },
                {
                    name: 'Alex Johnson',
                    role: 'Data Analyst',
                    quote: 'The projects helped me develop real-world skills that I couldn\'t learn in class. Highly recommend!',
                    earnings: '₭3M+ earned'
                }
            ]
        },
        cta: {
            ...
            subtitle: 'Join thousands of freelancers who are already earning money and building their careers on our platform.',
    ...
    projectDetail: {
        ...
        projectCompletedDesc: 'Both client and freelancer have marked the project as completed',
    ...
    createProject: {
        ...
        projectTypeDesc: 'Choose who can see and apply to your project, and how many freelancers can access it.',
        ...
        freelancers: 'freelancers',
        maxFreelancersDesc: 'Set how many freelancers can submit proposals to your project',
        ...
        descriptionPlaceholder: 'Describe your project in detail. Include requirements, goals, and any specific instructions...',
        projectDetails: 'Project Details',
        ...
        requirementsDesc: 'Add the skills needed and optional deadline for your project.',
        skillsRequired: 'Skills Required',
        skillPlaceholder: 'Add a skill (e.g., React, Python, Design)',
        add: 'Add',
        deadline: 'Deadline (Optional)',
        projectMedia: 'Project Media',
        mediaDesc: 'Add an image to make your project more attractive to freelancers.',
        ...
        emailVerificationMessage: 'You must verify your email address before you can create a project.',
        permissionDenied: 'Permission Denied',
        permissionDeniedMessage: 'Your account must be a client or both freelancer and client to create a project. Please update your account type in your profile.',
    ...
    projects: {
        ...
        hero: {
            ...
            subtitle: 'Browse through our community\'s projects and find opportunities that match your skills'
        },
        search: {
            title: 'Search Projects',
            subtitle: 'Use filters to find projects that match your skills and interests',
    ...
    proposals: {
        ...
        detail: {
            ...
            notFoundMessage: 'The proposal you are looking for does not exist or has been removed.',
    ...
    termsPage: {
        ...
        sections: {
            ...
            userResponsibilities: {
                ...
                content: 'Responsibilities for different types of users on the platform.',
                items: [
                    { role: 'Clients:', description: 'Must provide clear project requirements, respond to proposals in a timely manner, and pay for completed work as agreed.' },
                    { role: 'Freelancers:', description: 'Must deliver work according to project specifications, meet deadlines, and maintain professional communication.' },
                    { role: 'All Users:', description: 'Must not engage in fraudulent activities, spam, or harassment of other users.' }
                ]
            },
            paymentAndFees: {
            ...
            limitationOfLiability: {
                ...
                content: 'The Platform is not liable for any damages arising from the use of our services, including but not limited to project outcomes, communication issues, or payment disputes between users.'
            },
            termination: {
                title: '9. Termination',
            ...
            changesToTerms: {
                ...
                content: 'We reserve the right to modify these terms at any time. Users will be notified of significant changes, and continued use of the Platform constitutes acceptance of updated terms.'
            },
            contactInformation: {
    ...
    cookiePolicy: {
        ...
        sections: {
            ...
            howWeUseCookies: {
                ...
                content: 'We use cookies to enhance your experience and improve our platform.',
                items: [
                    { type: 'Essential Cookies:', description: 'These cookies are necessary for the website to function properly. They enable basic functions like page navigation and access to secure areas of the website.' },
                    { type: 'Performance Cookies:', description: 'These cookies help us understand how visitors interact with our website by collecting and reporting information anonymously.' },
                    { type: 'Functionality Cookies:', description: 'These cookies allow the website to remember choices you make and provide enhanced, more personal features.' },
                    { type: 'Targeting Cookies:', description: 'These cookies may be set through our site by our advertising partners to build a profile of your interests.' }
                ]
            },
            typesOfCookies: {
                ...
                items: [
                    {
                        ...
                        description: 'These cookies are temporary and are deleted when you close your browser. They help us maintain your session and remember your login status while you browse our platform.'
                    },
                    {
                        title: '2. Persistent Cookies',
                        description: 'These cookies remain on your device for a set period or until you delete them. They help us remember your preferences and settings for future visits.'
                    },
                    {
                        title: '3. Third-Party Cookies',
                        description: 'These cookies are set by third-party services we use, such as Google Analytics, payment processors, and social media platforms.'
                    }
                ]
            },
            specificCookies: {
                ...
                items: [
                    {
                        ...
                        description: 'Help us keep you logged in and secure your account information.'
                    },
                    {
                        title: 'Preference Cookies',
                        description: 'Remember your language preferences, theme settings, and other customization options.'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        description: 'Help protect against fraud and ensure secure transactions on our platform.'
                    }
                ]
            },
            managingCookies: {
                ...
                items: [
                    { method: 'Browser Settings:', description: 'Most browsers allow you to refuse cookies or delete them. Check your browser\'s help menu for instructions.' },
                    { method: 'Cookie Consent:', description: 'When you first visit our site, you can choose which types of cookies to accept.' },
                    { method: 'Third-Party Opt-Out:', description: 'You can opt out of third-party cookies through their respective privacy policies.' }
                ]
            },
            impactOfDisabling: {
                title: 'Impact of Disabling Cookies',
                content: 'Please note that disabling certain cookies may affect the functionality of our website. Essential cookies cannot be disabled as they are necessary for the platform to work properly.'
            },
            updatesToPolicy: {
                title: 'Updates to This Policy',
                content: 'We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will notify you of any material changes by posting the new policy on this page.'
            },
            contactUs: {
                title: 'Contact Us',
    ...
    privacyPage: {
        ...
        sections: {
            ...
            informationSharing: {
                ...
                description: 'We do not sell, trade, or rent your personal information to third parties. We may share your information in the following circumstances:',
                items: [
                    { label: 'With other users:', text: 'Your profile information is visible to other users as necessary for the platform to function' },
                    { label: 'Service providers:', text: 'We may share information with trusted third-party service providers who assist us in operating our platform' },
                    { label: 'Legal requirements:', text: 'We may disclose information if required by law or to protect our rights and safety' },
                    { label: 'Business transfers:', text: 'In the event of a merger or acquisition, your information may be transferred' }
                ]
            },
            dataSecurity: {
                title: 'Data Security',
            ...
            yourRights: {
                ...
                items: [
                    { label: 'Access:', text: 'You can request access to your personal information' },
                    { label: 'Correction:', text: 'You can update or correct your information through your account settings' },
                    { label: 'Deletion:', text: 'You can request deletion of your account and associated data' },
                    { label: 'Opt-out:', text: 'You can opt out of marketing communications' },
                    { label: 'Data portability:', text: 'You can request a copy of your data in a portable format' }
                ]
            },
            cookies: {
                ...
                items: [
                    { label: 'Essential cookies:', text: 'Required for basic platform functionality' },
                    { label: 'Analytics cookies:', text: 'Help us understand how users interact with our platform' },
                    { label: 'Preference cookies:', text: 'Remember your settings and preferences' },
                    { label: 'Marketing cookies:', text: 'Used for targeted advertising (with your consent)' }
                ],
                note: 'You can control cookie settings through your browser preferences.'
            },
            thirdPartyServices: {
                title: 'Third-Party Services',
                description: 'Our platform may contain links to third-party services or integrate with external services:',
                items: [
            ...
            childrenPrivacy: {
                ...
                content: 'Our platform is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13. If you believe we have collected information from a child under 13, please contact us immediately.'
            },
            internationalUsers: {
                title: 'International Users',
                content: 'If you are accessing our platform from outside the United States, please be aware that your information may be transferred to, stored, and processed in the United States where our servers are located. By using our platform, you consent to the transfer of your information to the United States.'
            },
            changesToPolicy: {
    ...
    landingPage: {
        hero: {
            ...
            subtitle: 'Join the largest academic freelancing community. Earn money while gaining real-world experience, building your portfolio, and growing your skills.',
        ...
        howItWorks: {
            ...
            step1: {
                title: 'Create Your Profile',
                description: 'Students and teachers sign up and create detailed profiles showcasing their skills, experience, and requirements.'
            },
            step2: {
                title: 'Post or Find Projects',
                description: 'Teachers post projects and assignments. Students browse and apply to projects that match their skills.'
            },
            step3: {
                title: 'Collaborate & Earn',
                description: 'Work together, complete projects, and students earn money while gaining valuable experience.'
            }
        },
        features: {
            title: 'Why Choose StudentFreelance?',
            ...
            earnWhileLearn: {
                ...
                description: 'Find opportunities that align with your studies and earn money to support your education'
            },
            buildPortfolio: {
                title: 'Build Your Portfolio',
                description: 'Gain real-world experience and build a professional portfolio that stands out to employers'
            },
            joinCommunity: {
                title: 'Join Our Community',
                description: 'Connect with thousands of students and opportunities in the largest academic freelancing network'
            }
        },
        userTypes: {
            title: 'For Freelancers & Clients',
            subtitle: 'Whether you\'re a freelancer looking for work or a client needing help, we\'ve got you covered',
            freelancers: {
                title: 'For Freelancers',
                description: 'Find freelance opportunities that align with your skills and career goals. Earn money while building your portfolio.',
                benefits: [
            ...
            clients: {
                title: 'For Clients',
                description: 'Find talented freelancers to help with your projects, research, and assignments. Get quality work done efficiently.',
                benefits: [
                    'Post projects and assignments',
    ...
    editProject: {
        ...
        describeProjectRequirements: 'Describe your project requirements, goals, and expectations...',
        ...
        describeExpectedTimelineMilestones: 'Describe the expected timeline and milestones...',
        ...
        projectNotFound: 'Project not found',
        invalidFileTypeError: 'Invalid file type. Only JPEG, PNG, GIF, and WebP images are allowed.',
    ...
    clientsPage: {
        ...
        howItWorks: {
            title: 'How It Works',
            subtitle: 'Get your projects completed quickly and efficiently with freelancers who have the skills we offer',
            steps: [
                {
                    title: '1. Post Your Project',
                    description: 'Describe your project requirements, budget, and timeline. Our platform helps you create detailed project descriptions easily.'
                },
                {
                    title: '2. Review Freelancers',
                    description: 'Get freelancers with the skills you need. Review profiles, ratings, and previous work to find the best fit.'
                },
                {
                    title: '3. Get Your Project Completed',
                    description: 'Hire the best freelancer and get your project completed through our platform. Track progress and ensure quality delivery.'
                }
            ]
        },
        benefits: {
            ...
            features: [
                {
                    ...
                    description: 'Our freelancers are vetted and rated, ensuring you get the best quality work in a timely manner.'
                },
                {
                    title: 'Affordable Rates',
                    description: 'Competitive rates with flexible payment options for the work you need.'
                },
                {
                    title: 'Quick Delivery',
                    description: 'Fast turnaround with freelancers available for urgent projects and tight deadlines.'
                },
                {
                    title: 'Easy Communication',
                    description: 'Connect with freelancers easily through our platform. Share project details and get updates in real-time.'
                },
                {
                    title: 'Secure Payments',
                ...
                },
                {
                    ...
                    description: 'Find freelancers with the skills you need. We have a wide range of skills to choose from.'
                }
            ]
        },
        popularCategories: {
            title: 'Popular Categories',
            subtitle: 'Find freelancers with the skills you need. We have a wide range of skills to choose from.',
            categories: [
                {
                    title: 'Web Development',
                    description: 'Web development, app development, and digital marketing.'
                },
                {
                    title: 'Content Writing',
    ...
    proposePage: {
        loading: 'Loading...',
        emailVerificationRequired: 'Email Verification Required',
        emailVerificationMessage: 'You must verify your email address before you can submit proposals or register for projects.',
        emailVerificationRedirect: 'You will be redirected to the home page shortly.',
        submitProposal: 'Submit Proposal',
        ...
        workSamplesUploadHint: 'Click or drag files here to upload (images, PDFs, docs, max 10MB)',
        uploading: 'Uploading...',
