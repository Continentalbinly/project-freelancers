  ...
  const CreditModal = () => (
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center px-4">
        <Dialog.Panel className="bg-white rounded-lg p-6 max-w-sm w-full border border-border shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                readOnly
                className="w-full px-3 py-2 border border-border rounded-lg bg-gray-50 text-text-secondary"
              />
            </div>
