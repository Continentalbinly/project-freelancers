        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="rounded-xl shadow border border-gray-200 dark:border-gray-700 animate-pulse"
              >
            ...
            completedProjects.map((project) => (
              <div
                key={project.id}
                className="rounded-xl shadow hover:shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300"
              >
