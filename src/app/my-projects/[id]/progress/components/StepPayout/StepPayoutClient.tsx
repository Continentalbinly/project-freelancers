...
export default function StepPayoutClient({ project }: { project: any }) {
  ...
  if (loading)
    return (
      <div className="max-w-md mx-auto p-6 text-center">
        <div className="w-64 h-64 mx-auto bg-gray-200 animate-pulse rounded-xl mb-6"></div>
  ...
  // ----------------------------------------------------------
  return (
    <div className="max-w-md mx-auto bg-white rounded-2xl shadow-sm p-6 text-center border border-gray-100 animate-fadeIn">
      {/* Title */}
