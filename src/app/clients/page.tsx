...
export default function ClientsPage() {
  ...
  useEffect(() => {
    ...
    const creatorIds = Array.from(new Set(projects.map(p => p.userId || p.clientId).filter(Boolean)))
    ...
    const fetchProfiles = async () => {
      ...
      for (let i = 0; i < creatorIds.length; i += 10) {
        ...
        const snap = await getDocs(q)
        snap.forEach(doc => { allProfiles[doc.id] = doc.data() })
      }
  ...
  const getStatusBadge = (status: string) => {
    const statusMap: { [key: string]: { color: string; label: string } } = {
      open: { color: 'bg-green-100 text-green-800', label: t('projects.statuses.open') },
      in_progress: { color: 'bg-yellow-100 text-yellow-800', label: t('projects.statuses.inProgress') },
      completed: { color: 'bg-blue-100 text-blue-800', label: t('projects.statuses.completed') },
      cancelled: { color: 'bg-red-100 text-red-800', label: t('projects.statuses.cancelled') }
    }
    const s = statusMap[status] || { color: 'bg-gray-100 text-gray-800', label: status }
    return (
      <span className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${s.color}`}>
        {s.label}
      </span>
    )
  }
  ...
  return (
    <div className="bg-background">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-secondary-light to-secondary py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auth/signup?type=client" className="btn btn-secondary px-8 py-4 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-text-primary mb-2">{t('clientsPage.projects.noProjects')}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.howItWorks.steps.0.title')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.howItWorks.steps.1.title')}</h3>
              <p className="text-text-secondary">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.howItWorks.steps.2.title')}</h3>
              <p className="text-text-secondary">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm border border-border p-6">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.benefits.features.0.title')}</h3>
              <p className="text-text-secondary">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.benefits.features.1.title')}</h3>
              <p className="text-text-secondary">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.benefits.features.2.title')}</h3>
              <p className="text-text-secondary">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.benefits.features.3.title')}</h3>
              <p className="text-text-secondary">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.benefits.features.4.title')}</h3>
              <p className="text-text-secondary">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-border p-6">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">{t('clientsPage.benefits.features.5.title')}</h3>
              <p className="text-text-secondary">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-text-primary mb-2">{t('clientsPage.popularCategories.categories.0.title')}</h3>
              <p className="text-text-secondary text-sm">{t('clientsPage.popularCategories.categories.0.description')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-text-primary mb-2">{t('clientsPage.popularCategories.categories.1.title')}</h3>
              <p className="text-text-secondary text-sm">{t('clientsPage.popularCategories.categories.1.description')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-text-primary mb-2">{t('clientsPage.popularCategories.categories.2.title')}</h3>
              <p className="text-text-secondary text-sm">{t('clientsPage.popularCategories.categories.2.description')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-text-primary mb-2">{t('clientsPage.popularCategories.categories.3.title')}</h3>
              <p className="text-text-secondary text-sm">{t('clientsPage.popularCategories.categories.3.description')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-secondary to-secondary-dark">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/projects" className="btn btn-outline border-white text-white hover:bg-white hover:text-secondary px-8 py-4 text-lg">
