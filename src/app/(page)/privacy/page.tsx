      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            {/* Introduction */}
            <div>
              <h2 className="text-2xl font-bold mb-4">{t('privacyPage.sections.introduction.title')}</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">{t('privacyPage.sections.informationWeCollect.title')}</h2>

              <h3 className="text-xl font-semibold mb-3">{t('privacyPage.sections.informationWeCollect.personalInfo.title')}</h3>
              <p className="text-text-secondary mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">{t('privacyPage.sections.informationWeCollect.automaticInfo.title')}</h3>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.howWeUseInformation.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            {/* Information Sharing */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.informationSharing.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            {/* Data Security */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.dataSecurity.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            {/* Your Rights */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.yourRights.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            {/* Cookies */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.cookies.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.thirdPartyServices.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            {/* Children's Privacy */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.childrenPrivacy.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            {/* International Users */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.internationalUsers.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            {/* Changes to Policy */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.changesToPolicy.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('privacyPage.sections.contactUs.title')}</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
