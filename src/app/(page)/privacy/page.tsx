          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">
                {t("privacyPage.sections.informationWeCollect.personalInfo.title")}
              </h3>
              <p className="text-base text-text-secondary leading-relaxed mb-4">
              ...
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.informationWeCollect.personalInfo.items.map(
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">
                {t("privacyPage.sections.informationWeCollect.automaticInfo.title")}
              </h3>
              <p className="text-base text-text-secondary leading-relaxed mb-4">
                {t("privacyPage.sections.informationWeCollect.automaticInfo.description")}
              </p>
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.informationWeCollect.automaticInfo.items.map(
                  (item: string, index: number) => (
                    <li key={index}>{item}</li>
                  )
                )}
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.howWeUseInformation.items.map(
                  (item: string, index: number) => (
                    <li key={index}>{item}</li>
                  )
                )}
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                {t("privacyPage.sections.informationSharing.title")}
              </h2>
              <p className="text-base text-text-secondary leading-relaxed mb-4">
                {t("privacyPage.sections.informationSharing.description")}
              </p>
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.informationSharing.items.map(
                  (
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.dataSecurity.items.map(
                  (item: string, index: number) => (
                    <li key={index}>{item}</li>
                  )
                )}
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.yourRights.items.map(
                  (
                    item: { label: string; text: string },
                    index: number
                  ) => (
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.cookies.items.map(
                  (
                    item: { label: string; text: string },
                    index: number
                  ) => (
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                {t("privacyPage.sections.thirdPartyServices.title")}
              </h2>
              <p className="text-base text-text-secondary leading-relaxed mb-4">
                {t("privacyPage.sections.thirdPartyServices.description")}
              </p>
              <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                {translations.privacyPage.sections.thirdPartyServices.items.map(
                  (item: string, index: number) => (
                    <li key={index}>{item}</li>
                  )
                )}
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                {t("privacyPage.sections.childrenPrivacy.title")}
              </h2>
              <p className="text-base text-text-secondary leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                {t("privacyPage.sections.internationalUsers.title")}
              </h2>
              <p className="text-base text-text-secondary leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                {t("privacyPage.sections.changesToPolicy.title")}
              </h2>
              <p className="text-base text-text-secondary leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                {t("privacyPage.sections.contactUs.title")}
              </h2>
              <p className="text-base text-text-secondary leading-relaxed mb-4">
              ...
              <div className="rounded-2xl border border-border bg-background-secondary p-6">
                <p className="text-base text-text-secondary mb-2">
                  <strong>{t("privacyPage.sections.contactUs.email")}</strong>{" "}
                  {t("privacyPage.sections.contactUs.emailAddress")}
                </p>
                <p className="text-base text-text-secondary mb-2">
                  <strong>{t("privacyPage.sections.contactUs.address")}</strong>{" "}
                  {t("privacyPage.sections.contactUs.addressValue")}
                </p>
                <p className="text-base text-text-secondary">
                  <strong>{t("privacyPage.sections.contactUs.phone")}</strong>{" "}
                  {t("privacyPage.sections.contactUs.phoneNumber")}
                </p>
              </div>
            </div>
          </div>
