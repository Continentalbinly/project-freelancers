...
export default function Step6Review({ formData, previewUrl, t }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* CREDIT OVERVIEW */}
      <div className="p-6 rounded-lg border border-border shadow-sm space-y-4 text-sm">
        {/* Your Credits */}
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold  ">{postingFee}</span>
        </div>
      ...
      {/* PROJECT SUMMARY */}
      <div className="p-6 rounded-lg border border-border shadow-sm text-sm space-y-3">
        <p>
