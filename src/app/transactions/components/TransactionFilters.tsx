...
export default function TransactionFilters({
  ...
  return (
    <div className="mb-6">
      <div className="p-5 border border-border rounded-xl bg-white shadow-sm space-y-5">
        {/* DESKTOP FILTER ROW (4 COLUMNS) */}
        {/* DESKTOP FILTER ROW (4 COLUMNS) */}
        <div className="hidden md:grid grid-cols-4 gap-4">
          {/* SEARCH */}
          <div className="space-y-1">
            <label className="text-xs font-semibold text-gray-600 flex items-center gap-1 h-5">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-border rounded-lg bg-gray-50 text-sm"
            >
              {typeOptions.map((opt) => (
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-3 py-2 border border-border rounded-lg bg-gray-50 hover:bg-gray-100 text-sm font-medium transition"
            >
