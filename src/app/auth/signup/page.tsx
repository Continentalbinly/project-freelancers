                  ...
                  >
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setFormData((prev) => ({
                          ...prev,
                          userRoles: newRoles as (
                            | "freelancer"
                            | "client"
                            | "admin"
                          )[],
                          userType: (newRoles.length > 0
                            ? newRoles[0]
                            : "freelancer") as
                            | "freelancer"
                            | "client"
                ...
                <div className="space-y-3 sm:space-y-4">
                  {formData.userRoles.includes("freelancer") && (
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-text-secondary space-y-1">
                        <li>
                          • {t("auth.signup.step1.benefits.freelancer.items.0")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.freelancer.items.1")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.freelancer.items.2")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.freelancer.items.3")}
                        </li>
                      </ul>
                    </div>
                  )}
                  {formData.userRoles.includes("client") && (
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-text-secondary space-y-1">
                        <li>
                          • {t("auth.signup.step1.benefits.client.items.0")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.client.items.1")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.client.items.2")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.client.items.3")}
                        </li>
                      </ul>
                    </div>
                  )}
                  {formData.userRoles.length > 1 && (
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-text-secondary space-y-1">
                        <li>
                          • {t("auth.signup.step1.benefits.dual.items.0")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.dual.items.1")}
                        </li>
                        <li>
                          • {t("auth.signup.step1.benefits.dual.items.2")}
                        </li>
                      </ul>
                    </div>
                  )}
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      >
                        ...
                        <div className="ml-3 sm:ml-4 flex-1">
                          <div className="flex items-center mb-2">
                            ...
                            <span className="text-base sm:text-lg font-semibold text-text-primary">
                              {t(
                                "auth.signup.step2.userCategory.student.title"
                              )}
                            </span>
                          </div>
                          <p className="text-sm text-text-secondary">
                            {t(
                              "auth.signup.step2.userCategory.student.description"
                            )}
                          </p>
                        </div>
                      </label>
                      ...
                      >
                        ...
                        <div className="ml-3 sm:ml-4 flex-1">
                          ...
                          <p className="text-sm text-text-secondary">
                            {t(
                              "auth.signup.step2.userCategory.worker.description"
                            )}
                          </p>
                        </div>
                      </label>
                      ...
                      >
                        ...
                        <div className="ml-3 sm:ml-4 flex-1">
                          <div className="flex items-center mb-2">
                            ...
                            <span className="text-base sm:text-lg font-semibold text-text-primary">
                              {t(
                                "auth.signup.step2.userCategory.freelancer.title"
                              )}
                            </span>
                          </div>
                          <p className="text-sm text-text-secondary">
                            {t(
                              "auth.signup.step2.userCategory.freelancer.description"
                            )}
                          </p>
                        </div>
                      </label>
                      ...
                      >
                        ...
                        <div className="ml-3 sm:ml-4 flex-1">
                          <div className="flex items-center mb-2">
                            ...
                            <span className="text-base sm:text-lg font-semibold text-text-primary">
                              {t(
                                "auth.signup.step2.clientCategory.teacher.title"
                              )}
                            </span>
                          </div>
                          <p className="text-sm text-text-secondary">
                            {t(
                              "auth.signup.step2.clientCategory.teacher.description"
                            )}
                          </p>
                        </div>
                      </label>
                      ...
                      >
                        ...
                        <div className="ml-3 sm:ml-4 flex-1">
                          <div className="flex items-center mb-2">
                            ...
                            <span className="text-base sm:text-lg font-semibold text-text-primary">
                              {t(
                                "auth.signup.step2.clientCategory.worker.title"
                              )}
                            </span>
                          </div>
                          <p className="text-sm text-text-secondary">
                            {t(
                              "auth.signup.step2.clientCategory.worker.description"
                            )}
                          </p>
                        </div>
                      </label>
                      ...
                      >
                        ...
                        <div className="ml-3 sm:ml-4 flex-1">
                          <div className="flex items-center mb-2">
                            ...
                            <span className="text-base sm:text-lg font-semibold text-text-primary">
                              {t(
                                "auth.signup.step2.clientCategory.freelancer.title"
                              )}
                            </span>
                          </div>
                          <p className="text-sm text-text-secondary">
                            {t(
                              "auth.signup.step2.clientCategory.freelancer.description"
                            )}
                          </p>
                        </div>
                      </label>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                            placeholder={t(
                              "auth.signup.step2.clientInfo.departmentPlaceholder"
                            )}
                          />
                        </div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-4 sm:mt-6">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                            placeholder={t(
                              "auth.signup.step2.clientInfo.positionPlaceholder"
                            )}
                          />
                        </div>
                        <div>
                          ...
                          >
                            {t(
                              "auth.signup.step2.clientInfo.yearsOfExperience"
                            )}
                          </label>
                          <input
                            ...
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                            placeholder={t(
                              "auth.signup.step2.clientInfo.yearsOfExperiencePlaceholder"
                            )}
                          />
                        </div>
                      </div>
                    ...
                    <div className="bg-secondary-light/10 rounded-xl p-4 sm:p-6 border border-secondary/20">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                            placeholder={t(
                              "auth.signup.step2.workerInfo.companyPlaceholder"
                            )}
                          />
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-4 sm:mt-6">
                        ...
                        <div>
                          ...
                          >
                            {t(
                              "auth.signup.step2.workerInfo.yearsOfExperience"
                            )}
                          </label>
                          <input
                            id="yearsOfExperience"
                      ...
                      <div className="mt-4 sm:mt-6">
                        ...
                        <textarea
                          ...
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                          placeholder={t(
                            "auth.signup.step2.workerInfo.bioPlaceholder"
                          )}
                        />
                      </div>
                      <div className="mt-4 sm:mt-6">
                        ...
                        <input
                          ...
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                          placeholder={t(
                            "auth.signup.step2.workerInfo.hourlyRatePlaceholder"
                          )}
                        />
                        <p className="text-xs text-text-muted mt-2">
                      ...
                      <div className="mt-4 sm:mt-6">
                        ...
                        <div className="flex gap-2 mb-3">
                          <input
                            ...
                            placeholder={t(
                              "auth.signup.step2.workerInfo.addSkill"
                            )}
                          />
                          <button
                            type="button"
                    ...
                    <div className="bg-secondary-light/10 rounded-xl p-4 sm:p-6 border border-secondary/20">
                      ...
                      <div className="mt-4 sm:mt-6">
                        ...
                        <input
                          ...
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                          placeholder={t(
                            "auth.signup.step2.pureFreelancerInfo.hourlyRatePlaceholder"
                          )}
                        />
                        <p className="text-xs text-text-muted mt-2">
                          {t(
                            "auth.signup.step2.pureFreelancerInfo.hourlyRateHint"
                          )}
                        </p>
                      </div>
                      <div className="mt-4 sm:mt-6">
                        ...
                        <div className="flex gap-2 mb-3">
                          <input
                            ...
                            className="flex-1 px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                            placeholder={t(
                              "auth.signup.step2.pureFreelancerInfo.addSkill"
                            )}
                          />
                          <button
                            type="button"
                          ...
                          >
                            {t(
                              "auth.signup.step2.pureFreelancerInfo.addSkillButton"
                            )}
                          </button>
                        </div>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <div className="bg-primary-light/10 rounded-xl p-4 sm:p-6 border border-primary/20">
                      ...
                      <div className="mt-4 sm:mt-6">
                        ...
                        <textarea
                          ...
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                          placeholder={t(
                            "auth.signup.step2.studentInfo.bioPlaceholder"
                          )}
                        />
                      </div>
                      ...
                      <div className="mt-4 sm:mt-6">
                        ...
                        <input
                          ...
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                          placeholder={t(
                            "auth.signup.step2.studentInfo.hourlyRatePlaceholder"
                          )}
                        />
                        <p className="text-xs text-text-muted mt-2">
                      ...
                      <div className="mt-4 sm:mt-6">
                        ...
                        <div className="flex gap-2 mb-3">
                          <input
                            ...
                            className="flex-1 px-3 sm:px-4 py-2 sm:py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                            placeholder={t(
                              "auth.signup.step2.studentInfo.addSkill"
                            )}
                          />
                          <button
                            type="button"
