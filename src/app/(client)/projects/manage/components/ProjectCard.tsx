...
export default function ProjectCard({ project, t, onProjectDeleted }: Props) {
  ...
  const getStatusColor = (status: string) => {
    ...
    return map[status] || "bg-background-secondary text-text-secondary";
  };
  ...
  return (
    <>
      ...
      <div
        ...
        className="border border-border rounded-xl bg-background p-5 sm:p-6 shadow-sm hover-surface cursor-pointer"
      >
        {/* TOP SECTION */}
        ...
        >
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4">
            <Transition.Child
              ...
              as={Fragment}
            >
              <Dialog.Panel className="bg-background rounded-xl shadow-xl max-w-md w-full p-6 border border-border">
                ...
                <div className="flex justify-end gap-3">
                  <button
                    ...
                    className="px-4 py-2 text-sm rounded-lg border border-border cursor-pointer hover:bg-background-tertiary"
                  >
                    {t("common.cancel")}
                  </button>
