  ...
  return (
    <div className="space-y-8">
      ...
      <div className="group">
        <div className="flex items-center justify-between mb-3">
          <label className="flex items-center gap-2 text-sm font-semibold text-text-primary">
            <div className="w-8 h-8 rounded-lg bg-linear-to-br from-primary/10 to-secondary/10 flex items-center justify-center group-focus-within:from-primary/20 group-focus-within:to-secondary/20 transition-all">
      ...
      <div className="group">
        <div className="flex items-center justify-between mb-3">
          <label className="flex items-center gap-2 text-sm font-semibold text-text-primary">
            <div className="w-8 h-8 rounded-lg bg-linear-to-br from-secondary/10 to-primary/10 flex items-center justify-center group-focus-within:from-secondary/20 group-focus-within:to-primary/20 transition-all">
