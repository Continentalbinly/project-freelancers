...
import { languages, supportedLanguages, defaultLanguage, Language } from '@/lib/i18n/config'
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        />
        <span className="text-sm text-text-primary">{languages[currentLanguage].nativeName}</span>
          ...
          {orderedLanguages.map(lang => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 text-left hover:bg-background-secondary transition-colors ${
                currentLanguage === lang ? 'bg-primary/10 text-primary' : 'text-text-primary'
              }`}
            >
              <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="md:hidden">
              ...
              >
                {t('footer.platform')}
                <svg className={`w-4 h-4 transition-transform ${expandedSections.platform ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
            </div>
            <h3 className="hidden md:block font-semibold text-text-primary mb-4">{t('footer.platform')}</h3>
            <div className={`md:block ${expandedSections.platform ? 'block' : 'hidden'}`}>
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/clients" className="text-text-secondary hover:text-primary transition-colors">
                    {t('footer.forClients')}
                  </Link>
                </li>
                <li>
          ...
          <div className="lg:col-span-1">
            <div className="md:hidden">
              ...
              >
                {t('footer.support')}
                <svg className={`w-4 h-4 transition-transform ${expandedSections.support ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
            </div>
            <h3 className="hidden md:block font-semibold text-text-primary mb-4">{t('footer.support')}</h3>
            <div className={`md:block ${expandedSections.support ? 'block' : 'hidden'}`}>
              <ul className="space-y-2">
                <li>
          ...
          <div className="lg:col-span-1">
            <div className="md:hidden">
              ...
              >
                {t('footer.company')}
                <svg className={`w-4 h-4 transition-transform ${expandedSections.company ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
            </div>
            <h3 className="hidden md:block font-semibold text-text-primary mb-4">{t('footer.company')}</h3>
            <div className={`md:block ${expandedSections.company ? 'block' : 'hidden'}`}>
              <ul className="space-y-2">
                <li>
                ...
                <li>
                  <Link href="/careers" className="text-text-secondary hover:text-primary transition-colors">
                    {t('footer.careers')}
                  </Link>
                </li>
              </ul>
