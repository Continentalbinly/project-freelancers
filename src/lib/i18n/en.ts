const en = {
  ...
  auth: {
    ...
    signup: {
      ...
      fields: {
        ...
        skills: "Top Skills",
        skillsUnit: "skills",
        skillsHint: "Type a skill and press Enter, comma, or click Add. Maximum 5 skills.",
        skillsLimitReached: "Maximum 5 skills reached. Remove a skill to add another.",
      ...
      placeholders: {
        ...
        city: "Vientiane",
        location: "Street address or district",
        ...
        skillsLimit: "Maximum 5 skills reached",
      },
      validations: {
      ...
      errors: {
        ...
        skillLimit: "Maximum 5 skills allowed",
      },
      roles: {
        freelancer: {
          title: "Freelancer",
      ...
      review: {
        ...
        readySubtitle: "Click 'Sign Up' to create your account.",
      },
      actions: {
        signup: "Sign Up",
      },
    ...
    verifyEmail: {
      ...
      buttons: {
        ...
        sending: "Sending...",
        goHome: "Go to Home",
        verifyLater: "Verify Later / Go Home",
  ...
  faq: {
    ...
    questions: {
      ...
      technicalIssues: {
        ...
        answer:
          "Contact our support team at support@UniJobs.app or use the live chat feature during business hours. We typically respond within 24 hours.",
      },
      isDataSecure: {
  ...
  pricing: {
    ...
    futurePlans: {
      ...
      basic: {
        title: "Basic",
        price: "Free",
        freePlanIncluded: "You have the Basic plan",
        youHaveTheBasicPlan: "You have the Basic plan",
        period: "Forever",
        features: [
      ...
      pro: {
        ...
        availableAfterLaunch: "Available after launch phase",
      },
      enterprise: {
        contactAdmin: "Contact our support",
        contactAdminNote: "For enterprise access, please message our admin.",
        title: "Enterprise",
        price: "Custom",
        period: "Contact us",
        features: [
  ...
  clientDashboard: {
    ...
    manageProjectsDesc: "View, edit, and track your projects",
    myOrders: "My Orders",
    myOrdersDesc: "Track catalog orders and delivery progress",
    myProjects: "My Projects",
    myProjectsDesc: "Track your posted projects and progress",
    hireFreelancer: "Hire Freelancer",
    hireFreelancerDesc: "Find and hire talented freelancers",
  ...
  freelancerDashboard: {
    ...
    myProjects: "My Projects",
    myProjectsDesc: "Track accepted projects and deliverables",
    ...
    myServicesDesc: "Manage your gigs and packages",
    orders: "Orders",
    ordersDesc: "Track catalog orders and delivery",
  },
  ...
  createProject: {
    ...
    of: "of",
    chars: "characters",
    minMaxHelper: "Min/Max characters",
  ...
  profile: {
    ...
    experience: {
      ...
      companyPlaceholder: "Enter your company name",
      periodLabel: "Period",
      periodPlaceholder: "Enter your period",
      startDate: "Start Date",
      endDate: "End Date",
      leaveEmptyForCurrent: "Leave empty for current",
      startDatePlaceholder: "Enter your start date",
      endDatePlaceholder: "Enter your end date",
      typeLabel: "Job Type",
    ...
    portfolio: {
      ...
      empty: "No portfolio items yet. Add your first item!",
      emptyPublic: "No portfolio items to display",
      featured: "Featured",
      requiredFields: "Please fill in all required fields",
      added: "Portfolio item added",
      updated: "Portfolio item updated",
      ...
      upload: {
        ...
        invalidImage: "Please select an image file (JPG, PNG, GIF, WebP)",
        imageTooLarge: "Image must be smaller than 10MB",
        invalidVideo: "Please select a video file (MP4, WebM, MOV)",
        videoTooLarge: "Video must be smaller than 500MB",
        failed: "Upload failed. Please try again.",
        maxSize: "Max",
        orEnterUrl: "Or enter URL manually",
        fileNote: "Enter a direct link to your file",
        clickToUploadMultiple: "Click to upload images & videos",
        uploadedFiles: "Uploaded Files",
        uploadMedia: "Upload Images & Videos",
        firstItemCover: "The first item will be set as the portfolio cover",
        required: "Please upload at least one image or video",
        invalidFile: "Please select an image or video file",
        addMoreMedia: "Add More Images & Videos (Optional)",
        newFilesNote: "New files will be added as separate portfolio items",
      },
      cover: "Cover",
      setAsCover: "Set as Portfolio Cover",
      coverSet: "Cover image set successfully",
      allItems: "All Portfolio Items",
    ...
    projects: {
      ...
      orders: "Orders",
      currentItems: {
        title: "Current Projects & Orders",
        emptyProjects: "No active projects or orders",
        emptyOrders: "No active orders",
        viewAllProjects: "View All Projects",
        viewAllOrders: "View All Orders",
        viewAll: "View All",
      },
      empty: "No projects posted yet",
    },
    catalogs: {
      title: "My Services",
  ...
  proposals: {
    ...
    detail: {
      ...
      due: "Due Date",
      rejectedStatus: "This proposal has been rejected.",
      withdrawnStatus: "This proposal has been withdrawn.",
    },
  ...
  userHomePage: {
    ...
    currentItems: {
      title: "Current Projects & Orders",
      empty: "No active projects or orders",
      viewAll: "View All →",
    },
    editor: {
      title: "Edit Profile",
    ...
    experience: {
      ...
      companyLabel: "Company",
      companyPlaceholder: "e.g., Tech Company Inc.",
      periodLabel: "Period",
      periodPlaceholder: "e.g., Jan 2020 - Dec 2022",
      startDate: "Start Date",
      endDate: "End Date",
      leaveEmptyForCurrent: "Leave empty for current",
  ...
  topup: {
    ...
    subtitle: "Choose an amount to add credits to your account",
    ...
    creditsInfo:
      "Credits are added to your account immediately after successful payment. You can top up multiple times and credits will accumulate.",
  },
  ...
  transactions: {
    ...
    types: {
      ...
      order_payout_received: "Order Payout Received",
      order_placement_fee: "Order Placement Fee",
  ...
  withdraw: {
    ...
    subtitle: "Request withdrawal of your earned income to your bank account",
    ...
    netAmount: "Amount You'll Receive",
    feeBreakdown: "Fee Breakdown",
    client: {
      description: "Withdraw your accumulated credits to your bank account.",
    },
    freelancer: {
      description: "Withdraw your earned income to your bank account. Processing typically takes 1-3 business days.",
    },
    options: {
    ...
    allButton: "Withdraw All",
    accessDenied: {
      title: "Access Restricted",
      message: "Withdrawal is only available for freelancers. Credits cannot be withdrawn as they are used for platform services.",
    },
    errors: {
    ...
    confirm: {
      ...
      subtitle: "Please review your withdrawal details",
      from: "From",
      amount: "Amount",
      fee: "Processing Fee",
      ...
      cancel: "Cancel",
      confirm: "Confirm",
      note: "Processing typically takes 1-3 business days.",
    ...
    summary: {
      ...
      credit: "Credit Balance",
      earned: "Total Earned",
      description: "This is the total amount you've earned from completed projects. You can withdraw any amount from this balance.",
    },
    history: {
  ...
  myProjects: {
    ...
    noProjectsInFilter: "No projects found",
    noProjectsInFilterDesc: "Try adjusting your search or filters",
  ...
  gigsPage: {
    ...
    subtitle: "Browse and filter freelancers' services",
    searchPlaceholder: "Search services, skills, or freelancers...",
    filter: "Filter",
    filters: "Filters",
    category: "Category",
    allCategories: "All Categories",
  ...
  ordersPage: {
    title: "My Orders",
    freelancerSubtitle: "Manage your freelance orders and deliveries",
    clientSubtitle: "Track your catalog orders and delivery progress",
    ...
    revenue: "Revenue",
    currencyLAK: "LAK",
    searchPlaceholder: "Search orders by package name…",
    all: "All",
    noOrdersFound: "No Orders Found",
    noOrdersMessage: "No orders match your filters",
    freelancer: "Freelancer",
    status: {
      pending: "Pending",
      accepted: "Accepted",
  ...
  notifications: {
    ...
    emptyDescription: "You'll see notifications here when there are updates on your orders",
    ...
    titles: {
      ...
      revisionReceived: "Revision Request Received",
      revisionAccepted: "Revision Accepted",
      revisionDeclined: "Revision Declined",
      orderCreated: "Order Placed",
      orderAcceptedByClient: "Order Accepted by Client",
      topupCompleted: "Top-up Completed",
      proposalSubmitted: "New Proposal",
      proposalAccepted: "Proposal Accepted",
      proposalRejected: "Proposal Rejected",
    },
    messages: {
      orderAccepted: {
        client: 'Your order "{{packageName}}" has been accepted by the freelancer.',
        freelancer: 'Your order "{{packageName}}" has been accepted and work will begin soon.',
      },
      orderInProgress: {
        client: 'Your order "{{packageName}}" is now in progress.',
        freelancer: 'Order "{{packageName}}" is now in progress.',
      },
      orderDelivered: {
        client: 'Your order "{{packageName}}" has been delivered. Please review it.',
        freelancer: 'Order "{{packageName}}" has been delivered to the client.',
      },
      orderCompleted: {
        client: 'Your order "{{packageName}}" has been completed.',
        freelancer: 'Order "{{packageName}}" has been completed.',
      },
      paymentReceived: {
        client: 'Payment for order "{{packageName}}" has been processed.',
        freelancer: 'Payment for order "{{packageName}}" has been received.',
      },
      revisionRequested: {
        client: 'Your revision request for order "{{packageName}}" has been sent to the freelancer.',
        freelancer: 'The client has requested a revision for order "{{packageName}}". Reason: {{reason}}',
      },
      revisionAccepted: {
        client: 'The freelancer has accepted your revision request for order "{{packageName}}". Work will resume on the changes.',
        freelancer: 'You have accepted the revision request for order "{{packageName}}". Work will resume on the changes.',
      },
      revisionDeclined: {
        client: 'The freelancer has declined your revision request for order "{{packageName}}". The original delivery is maintained.',
        freelancer: 'You have declined the revision request for order "{{packageName}}". The original delivery is maintained.',
      },
      orderCreated: {
        client: 'You\'ve placed an order for "{{packageName}}". {{orderFee}} credits have been deducted. Balance: {{balance}} credits.',
        freelancer: 'You\'ve received a new order for "{{packageName}}". Please review and accept it.',
      },
      orderAcceptedByClient: {
        freelancer: 'The client has accepted the delivery for order "{{packageName}}". Payment is now being processed.',
      },
      topupCompleted: "Your top-up of {{credits}} credits ({{amount}} LAK) has been successfully added to your account.",
      proposalSubmitted: {
        client: 'A freelancer has submitted a proposal for your project "{{projectTitle}}".',
        freelancer: 'Your proposal for "{{projectTitle}}" has been submitted successfully. {{proposalFee}} credits have been deducted.',
      },
      proposalAccepted: {
        freelancer: 'Your proposal for project "{{projectTitle}}" has been accepted! You can now start working on the project.',
      },
      proposalRejected: {
        freelancer: 'Your proposal for project "{{projectTitle}}" has been rejected. {{refundAmount}} credits have been refunded to your account.',
      },
    },
  },
  manageCatalogPage: {
  ...
  createCatalogPage: {
    ...
    subtitle: "Add a new service offering with multiple pricing tiers",
    stepBasics: "Basics",
    stepCategory: "Category & Tags",
    stepMedia: "Media",
    stepPackage: "Package",
    back: "Back",
    next: "Next",
  ...
  editCatalogPage: {
    title: "Edit Service",
    subtitle: "Update your service details and pricing",
    stepBasics: "Basics",
    stepCategory: "Category & Tags",
    stepMedia: "Media",
    stepPackage: "Package",
  ...
  stepCategory: {
    ...
    addTags: "Add Tags",
    tagPlaceholder: "Type a tag and press Enter or click Add",
    add: "Add",
    tagsHint: "Add relevant tags to help clients find your service",
  },
  stepMedia: {
    serviceImages: "Service Images",
    clickUpload: "Click to upload images",
    supportedFormats: "PNG, JPG, WebP up to 10MB",
    maxImages: "You can upload up to 3 images. Remove one to add more.",
    uploading: "Uploading...",
  ...
  stepPackage: {
    ...
    addTier: "Add Tier",
    name: "Package Name",
    namePlaceholder: "e.g., Basic, Standard, Premium",
    price: "Price (LAK)",
  ...
  orderDetail: {
    ...
    uploadFilesDesc: "Click to upload your work files",
    additionalNotes: "Additional notes or instructions...",
    pleaseUploadFiles: "Please upload at least one file",
    pleaseEnterDelivery: "Please enter delivery information",
    statusAwaitingPayment: "Awaiting Payment",
    clientInformation: "Client Information",
    clientId: "Client ID",
    freelancerInformation: "Freelancer Information",
    ...
    revisionReason: "What needs to be revised?",
    revisionReasonPlaceholder: "Describe what needs to be fixed or changed...",
    requestRevision: "Request Revision",
    revisionRequested: "Revision Requested",
    revisionRequestedDesc: "The client has requested revisions. Please review and accept or decline.",
    latestRevision: "Latest Revision Request",
    declineRevision: "Decline Revision",
    revisionAccepted: "Revision Accepted - Working on changes",
    revisionDeclined: "Revision Declined - Original delivery maintained",
    revisionAcceptedSuccess: "Revision accepted. You can now work on the changes.",
    revisionDeclinedSuccess: "Revision declined. Order returned to delivered status.",
  ...
  orderReview: {
    ...
    rateDescription: "Please rate your experience with this order",
  ...
  catalogDetail: {
    ...
    gallery: "Gallery",
    tags: "Tags",
    catalogPreview: "This is your catalog preview",
  ...
  checkout: {
    ...
    successMessage: "The freelancer will be notified",
  },
};
