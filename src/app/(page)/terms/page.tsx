    ...
    <div className="min-h-screen bg-background-secondary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">{t('termsPage.title')}</h1>
        ...
        <div className="bg-background rounded-xl shadow-sm border border-border p-6 sm:p-8">
          <div className="space-y-8">
            ...
            <section className="border-b border-border pb-8 last:border-b-0">
              <h2 className="text-2xl font-semibold mb-4">{t('termsPage.sections.acceptance.title')}</h2>
            ...
            <section className="border-b border-border pb-8 last:border-b-0">
              <h2 className="text-2xl font-semibold mb-4">{t('termsPage.sections.description.title')}</h2>
              <p className="text-text-secondary mb-4">
            ...
            {/* User Accounts */}
            <section className="border-b border-border pb-8 last:border-b-0">
              <h2 className="text-2xl font-semibold mb-4">{t('termsPage.sections.userAccounts.title')}</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">{t('termsPage.sections.userResponsibilities.title')}</h2>
              <p className="text-text-secondary mb-4">
            ...
            {/* Payment and Fees */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">{t('termsPage.sections.paymentAndFees.title')}</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">{t('termsPage.sections.intellectualProperty.title')}</h2>
              <p className="text-text-secondary mb-4">
            ...
            {/* Dispute Resolution */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold   mb-4">{t('termsPage.sections.disputeResolution.title')}</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold   mb-4">{t('termsPage.sections.limitationOfLiability.title')}</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            {/* Termination */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold   mb-4">{t('termsPage.sections.termination.title')}</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            {/* Changes to Terms */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold   mb-4">{t('termsPage.sections.changesToTerms.title')}</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            {/* Contact Information */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold   mb-4">{t('termsPage.sections.contactInformation.title')}</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
