...
export default function CareersPage() {
  ...
  return (
    <div className="bg-background ">
      {/* Hero Section */}
      <section className="bg-linear-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-950/20 py-12 sm:py-16 lg:py-20">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-linear-to-r from-primary to-secondary">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn text-primary px-8 py-4 text-lg">
              {t('careers.cta.contactUs')}
            </Link>
            <a href="mailto:careers@UniJobs.com" className="btn text-secondary px-8 py-4 text-lg">
